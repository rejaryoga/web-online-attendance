...
echo'<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      echo'
        ...
        if ($mod == 'absensi' OR $mod == 'laporanabsensi' OR $mod == 'cuti') {
        ...
        echo '
        <a href="#">
          <i class="fa fa-database"></i> <span>Absensi Karyawan</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        ...
        echo '<a href="./absensi"><i class="fa fa-circle-o"></i> Data Absensi</a></li>';
        if ($mod == 'laporanabsensi') {
          echo '<li class="active">';
        } else {
          echo '<li>';
        }
        echo '<a href="./laporanabsensi"><i class="fa fa-circle-o"></i> Laporan Absensi</a></li>';
        
        // Tambahkan bagian untuk cuti
        if ($mod == 'cuti') {
          echo '<li class="active">';
        } else {
          echo '<li>';
        }
        echo '<a href="./cuti"><i class="fa fa-circle-o"></i> Cuti</a></li>';
