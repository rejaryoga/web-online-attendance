...
$(document).on('click', '.btn-modal', function(){
  ...
  console.log(name); // Debugging line
...
$(document).ready(function() {
    // Memunculkan modal saat tombol "Tampilkan Laporan" diklik
    $('.btn-tampilkan-laporan').click(function() {
      $('#modal-laporan-harian').modal('show');
    });
  });
  $(document).ready(function() {
