	...
	<body>
  	...
  	<script type="text/javascript">
  		var mymap = L.map('peta').setView([<?php echo $latitude;?>, <?php echo $longitude;?>], 13);
            L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoicmVqYXIwOTkiLCJhIjoiY2xmYjUxNHJoMDFxOTNxcXF5aDQzNnprdCJ9.TFIVKiUsGXfYYol64JhaOw', {
              maxZoom: 20,
              attribution:'',
              id: 'mapbox/streets-v11',
              tileSize: 512,
              zoomOffset:-1,
              accessToken: 'pk.eyJ1IjoicmVqYXIwOTkiLCJhIjoiY2xmYjUxNHJoMDFxOTNxcXF5aDQzNnprdCJ9.TFIVKiUsGXfYYol64JhaOw'
            }).addTo(mymap);
