    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      <div class="box box-solid">
        ...
        <div class="box-body">
          ...
          <tbody>';          
          $query="SELECT employees.*, presence.presence_date,presence.picture_in,presence.picture_out,presence.time_in,presence.time_out, presence.presence_address FROM employees LEFT JOIN presence ON employees.id = presence.employees_id, position, shift, building WHERE employees.position_id=position.position_id AND employees.shift_id=shift.shift_id AND employees.building_id=building.building_id ORDER BY presence.presence_date DESC";
