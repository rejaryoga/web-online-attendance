...
echo'
  ...
  ob_end_clean();
  $encoding = 'UTF-8'; // set the original encoding
$html = mb_convert_encoding($html, 'HTML-ENTITIES', $encoding); // convert to HTML entities
$mpdf->WriteHTML($html, 0, false, true); // write the converted HTML
